...
using Schemio.Object.Tests.EntitySetup.EntitySchemas;
using Schemio.Object.PathMatchers;
...
namespace Schemio.Object.Tests.DataProvider
{
    ...
    internal class QueryBuilderTests
    {
        ...
        {
            var context = new CustomerContext { CustomerId = 1, Paths = new[] { "customer/customercode" } };
        ...
        {
            var context = new CustomerContext { CustomerId = 1, Paths = new[] { "customer/customercode", "customer/communication" } };
        ...
        {
            var context = new CustomerContext { CustomerId = 1, Paths = new[] { "customer/customercode", "customer/communication", "customer/orders" } };
        ...
        {
            var context = new CustomerContext { CustomerId = 1, Paths = new[] { "customer/customercode", "customer/communication", "customer/orders", "customer/orders/order/items" } };
